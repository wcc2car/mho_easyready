...
try:
    ...
    try:
        ...
        getattr(user32, "SetProcessDPIAware")()
    except (AttributeError, OSError):
        pass
...
TRANSLATIONS = {
    "zh_tw": {
        ...
        ########################################################################
        "MSG_B1_1": ">下載 MHServerEmu Stable v1.0.1:\n  ",
        ...
        "MSG_B1_6": ">MHServerEmu-1.0.1.zip 安裝作業失敗:\n  %s\n",
        "MSG_B1_7": ">MHServerEmu-1.0.1.zip 不存在.\n",
    ...
    "en_us": {
        ...
        ######################################################################
        "MSG_B1_1": ">Download MHServerEmu Stable v1.0.1:\n  ",
        ...
        "MSG_B1_6": ">MHServerEmu-1.0.1.zip installation failed:\n  %s\n",
        "MSG_B1_7": ">MHServerEmu-1.0.1.zip does not exist.\n",
